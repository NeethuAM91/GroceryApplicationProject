...
public class AdminPage {
	...
	private WebElement usertypeInSearch;
	@FindBy(xpath = "//i[@class='fa fa-search']")
	private WebElement searchInSearchfield;
	@FindBy(xpath = "//i[@class='ace-icon fa fa-sync-alt']")
	private WebElement resetInAdminPage;
	...
	private WebElement resettablefound;
	...
	@FindBy(xpath = "//input[@id='un']")
	private WebElement userSearchInAdmin;
