...
public class ManageNewsPage {
	...
	private WebElement newInmanageNews;

	public ManageNewsPage newInManageNewsClick() {
		WaitUtility wait = new WaitUtility();
		wait.waitUntilElementToBeClickable(driver, newInmanageNews);
	...
	private WebElement saveInmanageNews;
	...
	private WebElement searchInmanageNews;
	...
	private WebElement resetbuttoninmanagenews;

	public ManageNewsPage resetNewsinManageNews() {
		resetbuttoninmanagenews.click();
		return this;
	}

	@FindBy(xpath = "//h3[@class='card-title']")
	private WebElement textinmanagenews;
	...
	private WebElement textinmanagenewssearch;
	...
	private WebElement tableinmanagenewsreset;
